...
class Vgg19Resizable(Vgg19):
    def __init__(self, vgg19_npy_path=None):
        # Vgg19.__init__(self, vgg19_npy_path=None, trainable=True, dropout=0.5)
        super().__init__(vgg19_npy_path=vgg19_npy_path)
    ...
    def build(self, rgb, train_mode=None):
        ...
        self.fc7_custom = self.fc_layer(self.relu6, 1024, 2, "fc7_custom")
